...
import sys
sys.path.insert(0, '/media/umic/my_label/repositories/BEVFormer/mmdetection3d/BEVFormer')
...
def main():
    ...
    # meta['config'] = cfg.pretty_text  # takes unnessesarly long

    # log some basic info
    logger.info(f'Distributed training: {distributed}')
    # logger.info(f'Config:\n{cfg.pretty_text}')  # takes unnessesarly long
