import copy
import sys
sys.path.append('/media/umic/my_label/repositories/BEVFormer/mmdetection3d/BEVFormer/')
...
class CustomNuScenesDatasetV2(NuScenesDataset):
    ...
    def union2one(self, queue: dict):
        ...
        pts_list = [each['points'].data for each in queue.values()]
