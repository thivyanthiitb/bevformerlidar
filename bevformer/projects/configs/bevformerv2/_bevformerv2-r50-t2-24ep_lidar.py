...
ida_aug_conf = {
    "reisze": [512//shrink_factor, 544//shrink_factor, 576//shrink_factor, 608//shrink_factor, 640//shrink_factor, 672//shrink_factor, 704//shrink_factor, 736//shrink_factor, 768//shrink_factor],  #  (0.8, 1.2)
    "crop": (0, 260//shrink_factor, 1600//shrink_factor, 900//shrink_factor),
    "H": 900//shrink_factor,
    "W": 1600//shrink_factor,
    "rand_flip": False, # True,
}
ida_aug_conf_eval = {
    "reisze": [640//shrink_factor, ],
    "crop": (0, 260//shrink_factor, 1600//shrink_factor, 900//shrink_factor),
    "H": 900//shrink_factor,
    "W": 1600//shrink_factor,
    "rand_flip": False,
...
eval_pipeline = [
    ...
    dict(
        ...
        img_scale=(1600//shrink_factor, 640//shrink_factor),
        pts_scale_ratio=1,
        flip=False,
        transforms=[
            # BUG?: added!
...
model = dict(
    ...
    img_backbone=dict(
        ...
        # SyncBN doesn't work on single GPU training
